<template>
	<view>
		...
		<view class="form re">
			<view class="username">
				<input disabled="disabled" @click="sectype" placeholder="请选择身份" v-model="type" placeholder-style="color: rgba(255,255,255,0.8);"/>
			</view>
			<view class="username">
	...
	export default {
		...
		methods: {
			...
			if(this.passwd==""){
				...
				var that = this;
				uni.request({
								url: uni.getStorageSync("url") +'/user/add', //仅为示例，并非真实接口地址。
								method: "POST",
								data:{
